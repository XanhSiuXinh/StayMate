        ...
        <div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 relative z-10">
                    <div className="text-center max-w-3xl mx-auto mb-12">
                        ...
                        <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6 leading-tight tracking-tight">
                            ...
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-blue-600">Home & Roommate</span>
                        </h1>
                        <p className="text-xl text-gray-500 mb-8 leading-relaxed">
                            Connect with verified students, browse curated listings, and find a space where you truly belong. Simple, safe, and social.
                        </p>
                        ...
                        <div className="bg-white p-2 rounded-2xl shadow-xl border border-gray-100 max-w-2xl mx-auto flex flex-col md:flex-row gap-2">
                            <div className="flex-1 relative">
                                ...
                                <input
                                    type="text"
                                    placeholder="Search by city, university, or district..."
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-8 border-t border-gray-100 pt-12">
                        <div className="text-center">
                            ...
                            <div className="text-sm text-gray-500 font-medium">Verified Rooms</div>
                        </div>
                        <div className="text-center">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                <div className="flex justify-between items-end mb-10">
                    <div>
                        ...
                        <p className="text-gray-500 text-lg">Newest rooms added by our community today.</p>
                    </div>
            ...
            <div className="bg-gray-900 text-white py-20 px-4 mt-12 mb-12 rounded-3xl mx-4 sm:mx-8 lg:mx-12 overflow-hidden relative">
                ...
                <div className="max-w-4xl mx-auto text-center relative z-10">
                    <h2 className="text-3xl md:text-4xl font-bold mb-6">Ready to find your space?</h2>
                    <p className="text-gray-400 text-lg mb-8 max-w-2xl mx-auto">
                        Join thousands of students who have found their perfect home and roommates through StayMate.
                    </p>
